...
// NewWasmAppWithCustomOptions initializes a new CyberApp with custom options.
func NewWasmAppWithCustomOptions(t *testing.T, isCheckTx bool, options SetupOptions) *CyberApp {
	t.Helper()
