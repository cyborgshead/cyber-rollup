...
func TestWasmdExport(t *testing.T) {
	...
	gapp := NewCyberAppWithCustomOptions(t, false, SetupOptions{
	...
	newGapp := NewCyberApp(logger, db, nil, true, simtestutil.NewAppOptionsWithFlagHome(t.TempDir()), emptyWasmOpts)
