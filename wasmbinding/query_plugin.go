...
func CustomQuerier(qp *QueryPlugin) func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
	return func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
		var contractQuery bindings.CyberQuery
		...
		case contractQuery.BeforeSendHook != nil:
			...
			if err != nil {
				return nil, errorsmod.Wrap(err, "unable to get denom before_send_hook")
			}

			bz, err := json.Marshal(res)
			if err != nil {
				return nil, errorsmod.Wrap(err, "failed to JSON marshal BeforeSendHookResponse response")
			}
